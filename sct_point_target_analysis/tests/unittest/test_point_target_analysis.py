...
from sct_point_target_analysis.core.utilities import _compute_theoretical_rcs


def test_compute_theoretical_rcs(mocker):
    """Test high level function"""
    mocker.patch(
        "sct_point_target_analysis.core.utilities.compute_elevation_azimuth_wrt_enu",
        return_value=(0, 0),
    )
