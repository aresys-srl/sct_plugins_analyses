...
from sct_point_target_analysis.config import SCTPointTargetAnalysisCorrectionsConf
from sct_point_target_analysis.core.atmospheric_corrections_core import (
    IonosphericInput,
    TroposphereInput,
