...
Here is a detailed description on how to execute a Spectral Analysis with SCT in three ways:
...
The spectral analysis implementation also provides a testing interface, which can be used to run the analysis from the
