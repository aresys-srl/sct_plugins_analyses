...
Use this section as your starting point for understanding and applying the Radiometric workflow effectively.

## Basic usage

Radiometric Analysis can be performed using CLI or Python API, as described in the [usage documentation](usage.md).
...
from sct_radiometric_analysis.main import full_average_elevation_profiles_analysis
