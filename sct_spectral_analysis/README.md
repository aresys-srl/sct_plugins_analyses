# SCT Plugin: Spectral Analysis

[![PyPI version](https://img.shields.io/pypi/v/sct-spectral-analysis)](https://pypi.org/project/sct-spectral-analysis/)
...
[![CI](https://github.com/aresys-srl/sct_plugins_analyses/actions/workflows/spectra.yml/badge.svg)](https://github.com/aresys-srl/sct_plugins_analyses/actions/workflows/spectra.yml)

[SCT (SAR Calibration Toolbox)](https://github.com/aresys-srl/sct) plugin for performing
Point and Distributed Target Spectral Analysis on L1 SAR products. Enables spectral
characterization and quality assessment of SAR signals through SCT.

## Installation

``` bash
pip install sct-spectral-analysis
```
