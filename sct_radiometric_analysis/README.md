# SCT Plugin: Radiometric Analysis

[![PyPI version](https://img.shields.io/pypi/v/sct-radiometric-analysis)](https://pypi.org/project/sct-radiometric-analysis/)
...
[![CI](https://github.com/aresys-srl/sct_plugins_analyses/actions/workflows/radiometry.yml/badge.svg)](https://github.com/aresys-srl/sct_plugins_analyses/actions/workflows/radiometry.yml)

[SCT (SAR Calibration Toolbox)](https://github.com/aresys-srl/sct) plugin for performing
Distributed Radiometric Analysis on L1 SAR products. Enables NESZ estimation, radiometric
calibration assessment, and distributed target quality analysis through SCT.

## Installation

``` bash
pip install sct-radiometric-analysis
```
